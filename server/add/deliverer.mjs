  ...
  try {
    ...
    http.get('http://localhost:2000/api/location/last', (resp) => {
      ...
      resp.on('end', async () => {
        ...
        await client.query('INSERT INTO deliverer (deliverer_name, deliverer_firstname, deliverer_email, deliverer_password, deliverer_phone, deliverer_photo, deliverer_evaluation, deliverer_location) VALUES ($1, $2, $3, $4, $5, $6, $7, $8);', [name, firstname, email, cryptpassword, phone, photo, evaluation, idLocation]);
